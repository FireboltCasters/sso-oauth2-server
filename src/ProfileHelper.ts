...
type CallbackFunctionAnyReturn = (body: any, client_id: string, scope: string, query: any) => any;
...
export default class ProfileHelper {
    ...
    static extractToken(req: any){
        if (req.headers.authorization && req.headers.authorization.split(' ')[0] === TokenVerifier.BEARER) {
