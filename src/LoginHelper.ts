...
export default class LoginHelper {
    ...
    static async handleCredentialsPassed(req: any, res: any, next: any){
        console.log("doLogin");
        try{
            const dataToStore = await Authentification.handleAuth(req.body, req.query.client_id, req.query.scope, req.query);
            LoginHelper.handleSuccessfullAuthentification(req, res, next, dataToStore);
        } catch (err){
    ...
    static handleSuccessfullAuthentification(req: any, res: any, next: any, dataToStore: any){
        // else redirect
